...
verbs = 'парам пам-папам '.split()
verbs_text = {len(list(filter(lambda x: x in verbs, some))) for some in text}
print('Парам пам-папам па-ра-па-да' if len(verbs_text) == 1 else 'Парам Пам пам')